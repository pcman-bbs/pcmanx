...
static NS_DEFINE_IID(kIScriptableIID, PCMANX_INTERFACE_IID);
...
{ 
  ...
  if(aIID.Equals(kIScriptableIID)) {
    *aInstancePtr = static_cast<PCManX_interface*>(this); 
    AddRef();
    return NS_OK;
  }
  ...
  if(aIID.Equals(kISupportsIID)) {
    *aInstancePtr = static_cast<nsISupports*>(static_cast<PCManX_interface*>(this)); 
    AddRef();
    return NS_OK;
  }
